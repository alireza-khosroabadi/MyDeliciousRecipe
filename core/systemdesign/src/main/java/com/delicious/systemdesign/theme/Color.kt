...
val PrimaryColor = Color(0xFFFC8B56)
val DarkPrimaryColor = Color(0xFF244341)
val AccentColor = Color(0xFFFC8B56)
val DarkAccentColor = Color(0xFF4A411C)
val ErrorColor = Color(0xFFFF8C8C)
val DarkErrorColor = Color(0xFF4A2A2C)
val PrimaryBackgroundColor = Color(0xFFFFFFFF)
val SecondaryBackgroundColor = Color(0xFFFFFFFF)
val GradientEndColor = Color(0xFF232526)
val BoxColor = Color(0xFFCCCCCC)
val BoxBorderColor = Color(0xFF454545)
val BoxContainerColor = Color(0xFF232526)
val PrimaryTextColor = Color(0xFFFFFFFF)
val SecondaryTextColor = Color(0xFFCCCCCC)
val DisabledTextColor = Color(0xFF87898C)
val DialogueColor = Color(0xFF28292B)
